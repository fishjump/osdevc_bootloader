...
EFI_STATUS locateGraphicOutputProtocol(
    ...
    return locateProtocol(&gEfiGraphicsOutputProtocolGuid, NULL,
...
EFI_STATUS closeGraphicOutputProtocol(
    ...
    return closeProtocol(graphicsOutputProtocol,
                         &gEfiGraphicsOutputProtocolGuid, agentHandle,
                         NULL);
}
...
EFI_STATUS queryMode(EFI_GRAPHICS_OUTPUT_PROTOCOL *graphicsOutputProtocol,
    ...
    return uefi_call_wrapper(graphicsOutputProtocol->QueryMode, 4,
                             graphicsOutputProtocol, modeNumber,
                             sizeOfInfo, info);
}

EFI_STATUS setMode(EFI_GRAPHICS_OUTPUT_PROTOCOL *graphicsOutputProtocol,
                   UINT32                        modeNumber) {
    return uefi_call_wrapper(graphicsOutputProtocol->SetMode, 2,
                             graphicsOutputProtocol, modeNumber);
}
